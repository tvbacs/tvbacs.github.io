...
var listVrSapa = [
    "../html/htmlsVr/fansipang.html",
    "../html/htmlsVr/thactinhyeu.html",
    "../html/htmlsVr/catcat.html"
];
var listVrMocchau = [
    "../html/htmlsVr/doichetraitim.html",
    "../html/htmlsVr/dinhpaphach.html",
    "../html/htmlsVr/thacgiaiyem.html"
];
var namePlaceSapa = [
    'Thac Tinh Yeu',
    'Ban cat cat',
...
var imgSongs = [
    "https://github.com/tvbacs/BaiTap_Java/blob/master/imgsAll/imgsVietJ/Hanoi%20in%20autumn%201.png?raw=true",
    "https://github.com/tvbacs/BaiTap_Java/blob/master/imgsAll/imgsVietJ/duanhauditron.jpg?raw=true"
];
var audioSongs = [
    "../videos/y2mate.com - Cứ Chill Thôi  Chillies Official Music Video ft Suni Hạ Linh  Rhymastic.mp3",
    "../videos/đưa nhau đi trốn.mp3"
];
var authorSongs = [
    "Sai đẹp chiêu",
    "Đen"
...
var imgContentNinhBinhs = [
        "../imgsAll/imgsVietJ/imgninhbinh1.png",
        "../imgsAll/imgsVietJ/imgninhbinh2.png",
        "../imgsAll/imgsVietJ/imgninhbinh3.png",
        "../imgsAll/imgsVietJ/imgninhbinh4.png",
        "../imgsAll/imgsVietJ/imgninhbinh5.png",      
]
var titlePlaces = [
    "chua",
    "Hang Mua",
...
function changeTitleOverlayNinhBinh(index){
    switch(index) {
        ...
        contentThreeOverlayItem.innerText="";        break;
        case 2: 
...
var listImgItemQuangBinh = [
    "../imgsAll/imgsVietJ/imgquangbinh1.png",
    "../imgsAll/imgsVietJ/imgquangbinh2.png",
    "../imgsAll/imgsVietJ/imgquangbinh3.png",
    "../imgsAll/imgsVietJ/imgquangbinh4.png",
]
var linkItemQuangBinhs = [
    "",
    "../html/htmlsVr/thienduongisland.html",
    "",
    "",
]
