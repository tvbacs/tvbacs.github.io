...
const imgChoices = document.querySelectorAll('.js-choice-img');
const desChoice = document.querySelector('.js-choice-des');
...
var bodyticketslistItems = document.querySelectorAll('.body_tickets-list-item');
// Thêm sự kiện mouseenter để xóa class "hover"
