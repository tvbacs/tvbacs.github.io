...
document.getElementById('js-get-img-inspi').addEventListener('change', function () {
  ...
  if (file) {
    ...
    reader.onload = function (e) {
      var imgElement = document.getElementById('js-set-img-inspi');
...
var $$ = document.querySelectorAll.bind(document); // change content
...
navbarItems.forEach(function (navbarItem, index) {
  navbarItem.onclick = function () {
    ...
    contents[index - 1].style.display = "block"; // Remove 'active' class from all navbar items
